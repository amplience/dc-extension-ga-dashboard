...
import { useData, useAnalyticsApi, Query } from 'react-use-analytics-api';
import DashboardWidget from '../components/DashboardWidget';
import { DashboardState, DashboardStateContext } from '../components/DashboardState';
import TopContentWidget from '../components/TopContentWidget';
import EventsChartWidget from '../components/EventsChartWidget';
import { DateRangePicker, Toolbar, DashboardContent } from '../components/ui';
...
const DashboardPage: React.SFC<Props> = (props) => {
    ...
    return (
        <DashboardStateContext.Provider value={dashboardState}>
            <ToolbarLayout toolbarChildren={
                <div className={classes.toolbar}>
                    Date range <DateRangePicker value={dateValue} onChange={setDateValue} />
                </div>
            }>
